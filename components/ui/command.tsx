...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Group
    ...
    className={cn(
      ...
      "**:[[cmdk-group-heading]]:text-gray-500 dark:**:[[cmdk-group-heading]]:text-gray-400",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Separator
    ref={ref}
    className={cn("-mx-1 h-px bg-gray-200 dark:bg-slate-700", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ...
    className={cn(
      ...
      "dark:aria-selected:bg-slate-800 dark:aria-selected:text-gray-100",
